...
async function seed() {
  try {
    ...
    const p1StudyVolMap = {
      'alice.chen@educonnect.com': { subjects: ['Statistics', 'CS'],    rating: 4.8, ratingCount: 5, totalSessions: 40, availability: 'This Week',    bio: 'PhD in Applied Mathematics with 8 years of teaching experience.', dailySessionLimit: 6, todaysSessions: 0 },
      'bob.m@educonnect.com':      { subjects: ['Python', 'DSA', 'CS'], rating: 4.7, ratingCount: 4, totalSessions: 30, availability: 'Any Time',     bio: 'Senior software engineer and CS mentor.',                          dailySessionLimit: 6, todaysSessions: 1 },
      'sarah.j@educonnect.com':    { subjects: ['Statistics', 'CS'],    rating: 4.3, ratingCount: 3,  totalSessions: 18, availability: 'This Week',    bio: 'MSc Chemistry student passionate about teaching.',                  dailySessionLimit: 5, todaysSessions: 0 },
      'david.k@educonnect.com':    { subjects: ['Statistics', 'CS'],    rating: 5.0, ratingCount: 4, totalSessions: 55, availability: 'This Week',    bio: 'Retired physics professor with 12 yrs experience.',                 dailySessionLimit: 4, todaysSessions: 0 },
    };
    const p1StudyVols = {};
    for (const [email, volData] of Object.entries(p1StudyVolMap)) {
      const u = p1Users[email];
      if (u) {
        const sv = await StudyVolunteer.create({ user: u._id, name: u.name, email: u.email, ...volData });
        p1StudyVols[email] = sv;
    ...
    const p3VolData = [
      { user: { name: 'Kavindu Hewa',   email: 'kavindu@educonnect.com'  }, vol: { subjects: ['Java','Python','MERN'],            rating: 4.5, ratingCount: 4, totalSessions: 20, availability: 'Any Time',     bio: 'Full-stack developer with 2 yrs tutoring.',   dailySessionLimit: 6, todaysSessions: 2 }},
      { user: { name: 'Nimali Perera',   email: 'nimali@educonnect.com'   }, vol: { subjects: ['DSA','OOP','C++'],                 rating: 4.3, ratingCount: 3,  totalSessions: 15, availability: 'This Week',    bio: 'CS tutor specializing in algorithms.',         dailySessionLimit: 5, todaysSessions: 0 }},
      { user: { name: 'Ravindu Silva',   email: 'ravindu@educonnect.com'  }, vol: { subjects: ['Java','Springboot','OOP'],         rating: 4.8, ratingCount: 5, totalSessions: 30, availability: 'Available Now', bio: 'Java/Spring Boot expert, backend specialist.', dailySessionLimit: 8, todaysSessions: 1 }},
      { user: { name: 'Hashini Kumari',  email: 'hashini@educonnect.com'  }, vol: { subjects: ['Python','Statistics','CS'],        rating: 4.0, ratingCount: 3,  totalSessions: 10, availability: 'Any Time',     bio: 'Data science enthusiast and Python mentor.',   dailySessionLimit: 4, todaysSessions: 0 }},
      { user: { name: 'Lakshan Bandara', email: 'lakshan@educonnect.com'  }, vol: { subjects: ['Networking','Project Management'], rating: 4.0, ratingCount: 2,  totalSessions: 8,  availability: 'This Week',    bio: 'IT professional helping with networking basics.', dailySessionLimit: 3, todaysSessions: 0 }},
    ];
    ...
    // --- Seeded review SupportRequests (one per completed session with rating) ---
    ...
    await SupportRequest.insertMany([
      // ── Dr. Alice Chen (5 reviews) ────────────────────────────────────────────
      { studentName: 'Ava Perera',        volunteer: p1StudyVols['alice.chen@educonnect.com']._id, volunteerName: 'Dr. Alice Chen',  subject: 'Statistics', date: d30, timeSlot: '10:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Dr. Chen explained probability distributions in a way that finally clicked for me.',        reviewSubject: 'Probability Distributions', feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d30 },
      { studentName: 'Dilini Wickrama',   volunteer: p1StudyVols['alice.chen@educonnect.com']._id, volunteerName: 'Dr. Alice Chen',  subject: 'CS',         date: d21, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Brilliant session on data structures. Very patient and thorough.',                           reviewSubject: 'Data Structures',          feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d21 },
      { studentName: 'Priya De Silva',    volunteer: p1StudyVols['alice.chen@educonnect.com']._id, volunteerName: 'Dr. Alice Chen',  subject: 'Statistics', date: d21, timeSlot: '11:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: false, feedbackTags: ['positive'],         reviewText: 'Clear explanations of hypothesis testing. Highly recommend.',                               reviewSubject: 'Hypothesis Testing',       feedbackVisibility: 'public', goalAlignmentScore: 80,  reviewCreatedAt: d21 },
      { studentName: 'Kasun Rajapaksha',  volunteer: p1StudyVols['alice.chen@educonnect.com']._id, volunteerName: 'Dr. Alice Chen',  subject: 'CS',         date: d14, timeSlot: '03:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['neutral'],          reviewText: 'Good session overall, covered algorithms well.',                                            reviewSubject: 'Algorithms',               feedbackVisibility: 'public', goalAlignmentScore: 90,  reviewCreatedAt: d14 },
      { studentName: 'Malith Fernando',   volunteer: p1StudyVols['alice.chen@educonnect.com']._id, volunteerName: 'Dr. Alice Chen',  subject: 'Statistics', date: d7,  timeSlot: '09:00 AM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Very helpful with regression analysis. Will book again.',                                   reviewSubject: 'Regression Analysis',      feedbackVisibility: 'public', goalAlignmentScore: 88,  reviewCreatedAt: d7  },
      // ── Bob Martinez (4 reviews) ──────────────────────────────────────────────
      { studentName: 'Tharushi Fernando', volunteer: p1StudyVols['bob.m@educonnect.com']._id,       volunteerName: 'Bob Martinez',    subject: 'Python',     date: d45, timeSlot: '10:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Bob made Python generators easy to understand. Great tutor!',                               reviewSubject: 'Python Generators',        feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d45 },
      { studentName: 'Roshan Jayasinghe', volunteer: p1StudyVols['bob.m@educonnect.com']._id,       volunteerName: 'Bob Martinez',    subject: 'DSA',        date: d30, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: false, feedbackTags: ['positive'],         reviewText: 'Thorough walkthrough of graph algorithms. Excellent session.',                              reviewSubject: 'Graph Algorithms',         feedbackVisibility: 'public', goalAlignmentScore: 80,  reviewCreatedAt: d30 },
      { studentName: 'Nimal Jayawardena', volunteer: p1StudyVols['bob.m@educonnect.com']._id,       volunteerName: 'Bob Martinez',    subject: 'CS',         date: d21, timeSlot: '04:00 PM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Helped me understand Big O notation clearly. Very knowledgeable.',                          reviewSubject: 'Big O Complexity',         feedbackVisibility: 'public', goalAlignmentScore: 88,  reviewCreatedAt: d21 },
      { studentName: 'Hasini Gunaratna',  volunteer: p1StudyVols['bob.m@educonnect.com']._id,       volunteerName: 'Bob Martinez',    subject: 'Python',     date: d14, timeSlot: '11:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['neutral'],          reviewText: 'Good explanation of OOP concepts in Python.',                                               reviewSubject: 'Python OOP',               feedbackVisibility: 'public', goalAlignmentScore: 90,  reviewCreatedAt: d14 },
      // ── Sarah Johnson (3 reviews) ─────────────────────────────────────────────
      { studentName: 'Ava Perera',        volunteer: p1StudyVols['sarah.j@educonnect.com']._id,     volunteerName: 'Sarah Johnson',   subject: 'Statistics', date: d45, timeSlot: '09:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Sarah made statistics much more approachable. Very helpful session.',                       reviewSubject: 'Descriptive Statistics',   feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d45 },
      { studentName: 'Dilini Wickrama',   volunteer: p1StudyVols['sarah.j@educonnect.com']._id,     volunteerName: 'Sarah Johnson',   subject: 'CS',         date: d30, timeSlot: '03:00 PM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: false, feedbackTags: ['positive'],         reviewText: 'Good session on database fundamentals.',                                                    reviewSubject: 'Database Design',          feedbackVisibility: 'public', goalAlignmentScore: 68,  reviewCreatedAt: d30 },
      { studentName: 'Priya De Silva',    volunteer: p1StudyVols['sarah.j@educonnect.com']._id,     volunteerName: 'Sarah Johnson',   subject: 'Statistics', date: d14, timeSlot: '01:00 PM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['neutral'],          reviewText: 'Covered the material well, helped me prepare for my exam.',                                 reviewSubject: 'Statistical Testing',      feedbackVisibility: 'public', goalAlignmentScore: 78,  reviewCreatedAt: d14 },
      // ── Prof. David Kim (4 reviews) ───────────────────────────────────────────
      { studentName: 'Kasun Rajapaksha',  volunteer: p1StudyVols['david.k@educonnect.com']._id,     volunteerName: 'Prof. David Kim', subject: 'Statistics', date: d45, timeSlot: '10:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Prof. Kim is exceptional. His physics background gives unique insights into statistics.',   reviewSubject: 'Probability Theory',       feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d45 },
      { studentName: 'Nimal Jayawardena', volunteer: p1StudyVols['david.k@educonnect.com']._id,     volunteerName: 'Prof. David Kim', subject: 'CS',         date: d30, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Outstanding session. 12 years of experience really shows. Best tutor I have had.',          reviewSubject: 'CS Fundamentals',          feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d30 },
      { studentName: 'Malith Fernando',   volunteer: p1StudyVols['david.k@educonnect.com']._id,     volunteerName: 'Prof. David Kim', subject: 'Statistics', date: d21, timeSlot: '11:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: false, feedbackTags: ['positive'],         reviewText: 'Extremely clear explanations of statistical models. Highly recommended.',                   reviewSubject: 'Statistical Models',       feedbackVisibility: 'public', goalAlignmentScore: 80,  reviewCreatedAt: d21 },
      { studentName: 'Roshan Jayasinghe', volunteer: p1StudyVols['david.k@educonnect.com']._id,     volunteerName: 'Prof. David Kim', subject: 'Statistics', date: d14, timeSlot: '03:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['neutral'],          reviewText: 'Great session on regression. Very knowledgeable professor.',                                reviewSubject: 'Regression',               feedbackVisibility: 'public', goalAlignmentScore: 90,  reviewCreatedAt: d14 },
      // ── Kavindu Hewa (4 reviews) ──────────────────────────────────────────────
      { studentName: 'Ava Perera',        volunteer: studyVols[0]._id, volunteerName: 'Kavindu Hewa',    subject: 'Java',       date: d45, timeSlot: '10:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Kavindu helped me understand Java OOP from the ground up. Great session!',                  reviewSubject: 'Java OOP',                 feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d45 },
      { studentName: 'Tharushi Fernando', volunteer: studyVols[0]._id, volunteerName: 'Kavindu Hewa',    subject: 'MERN',       date: d30, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Really helpful with React hooks and context. Clear explanations.',                          reviewSubject: 'React Hooks',              feedbackVisibility: 'public', goalAlignmentScore: 88,  reviewCreatedAt: d30 },
      { studentName: 'Hasini Gunaratna',  volunteer: studyVols[0]._id, volunteerName: 'Kavindu Hewa',    subject: 'Python',     date: d21, timeSlot: '11:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: false, feedbackTags: ['neutral'],          reviewText: 'Good coverage of Python basics. Would recommend.',                                          reviewSubject: 'Python Basics',            feedbackVisibility: 'public', goalAlignmentScore: 70,  reviewCreatedAt: d21 },
      { studentName: 'Dilini Wickrama',   volunteer: studyVols[0]._id, volunteerName: 'Kavindu Hewa',    subject: 'Java',       date: d14, timeSlot: '04:00 PM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['neutral'],          reviewText: 'Kavindu is patient and explains concepts step by step.',                                    reviewSubject: 'Java Fundamentals',        feedbackVisibility: 'public', goalAlignmentScore: 78,  reviewCreatedAt: d14 },
      // ── Nimali Perera (3 reviews) ─────────────────────────────────────────────
      { studentName: 'Nimal Jayawardena', volunteer: studyVols[1]._id, volunteerName: 'Nimali Perera',   subject: 'DSA',        date: d45, timeSlot: '09:00 AM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Great explanation of binary trees and recursion. Very helpful.',                            reviewSubject: 'Binary Trees',             feedbackVisibility: 'public', goalAlignmentScore: 88,  reviewCreatedAt: d45 },
      { studentName: 'Kasun Rajapaksha',  volunteer: studyVols[1]._id, volunteerName: 'Nimali Perera',   subject: 'OOP',        date: d21, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: false, feedbackTags: ['positive'],         reviewText: 'Nimali explained design patterns with excellent examples.',                                 reviewSubject: 'Design Patterns',          feedbackVisibility: 'public', goalAlignmentScore: 80,  reviewCreatedAt: d21 },
      { studentName: 'Malith Fernando',   volunteer: studyVols[1]._id, volunteerName: 'Nimali Perera',   subject: 'C++',        date: d14, timeSlot: '11:00 AM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: false, feedbackTags: ['neutral'],          reviewText: 'Helpful session on pointers and memory management.',                                        reviewSubject: 'C++ Pointers',             feedbackVisibility: 'public', goalAlignmentScore: 58,  reviewCreatedAt: d14 },
      // ── Ravindu Silva (5 reviews) ─────────────────────────────────────────────
      { studentName: 'Ava Perera',        volunteer: studyVols[2]._id, volunteerName: 'Ravindu Silva',   subject: 'Java',       date: d45, timeSlot: '10:00 AM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Ravindu is an expert Java developer. He explained Spring Boot REST APIs perfectly.',        reviewSubject: 'Spring Boot REST',         feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d45 },
      { studentName: 'Nimal Jayawardena', volunteer: studyVols[2]._id, volunteerName: 'Ravindu Silva',   subject: 'Springboot', date: d30, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Outstanding session on microservices architecture. Real-world examples were very helpful.',  reviewSubject: 'Microservices',            feedbackVisibility: 'public', goalAlignmentScore: 100, reviewCreatedAt: d30 },
      { studentName: 'Roshan Jayasinghe', volunteer: studyVols[2]._id, volunteerName: 'Ravindu Silva',   subject: 'OOP',        date: d21, timeSlot: '11:00 AM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Excellent walkthrough of SOLID principles. Will definitely book again.',                    reviewSubject: 'SOLID Principles',         feedbackVisibility: 'public', goalAlignmentScore: 88,  reviewCreatedAt: d21 },
      { studentName: 'Tharushi Fernando', volunteer: studyVols[2]._id, volunteerName: 'Ravindu Silva',   subject: 'Java',       date: d14, timeSlot: '03:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: false, feedbackTags: ['positive'],         reviewText: 'Ravindu explained Java streams and lambdas very clearly.',                                  reviewSubject: 'Java Streams',             feedbackVisibility: 'public', goalAlignmentScore: 80,  reviewCreatedAt: d14 },
      { studentName: 'Hasini Gunaratna',  volunteer: studyVols[2]._id, volunteerName: 'Ravindu Silva',   subject: 'Springboot', date: d7,  timeSlot: '01:00 PM', message: '-', status: 'completed', rating: 5, followUpMatchAgain: true,  feedbackTags: ['neutral'],          reviewText: 'Very knowledgeable about Spring Boot security. Covered all my questions.',                  reviewSubject: 'Spring Security',          feedbackVisibility: 'public', goalAlignmentScore: 90,  reviewCreatedAt: d7  },
      // ── Hashini Kumari (3 reviews) ────────────────────────────────────────────
      { studentName: 'Ava Perera',        volunteer: studyVols[3]._id, volunteerName: 'Hashini Kumari',  subject: 'Statistics', date: d45, timeSlot: '09:00 AM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: true,  feedbackTags: ['positive'],         reviewText: 'Hashini helped me understand regression with real examples. Clear and patient.',            reviewSubject: 'Regression Analysis',      feedbackVisibility: 'public', goalAlignmentScore: 88,  reviewCreatedAt: d45 },
      { studentName: 'Priya De Silva',    volunteer: studyVols[3]._id, volunteerName: 'Hashini Kumari',  subject: 'Python',     date: d21, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: false, feedbackTags: ['neutral'],          reviewText: 'Good session on Python data science libraries. Helpful introduction.',                      reviewSubject: 'Pandas & NumPy',           feedbackVisibility: 'public', goalAlignmentScore: 58,  reviewCreatedAt: d21 },
      { studentName: 'Dilini Wickrama',   volunteer: studyVols[3]._id, volunteerName: 'Hashini Kumari',  subject: 'CS',         date: d14, timeSlot: '11:00 AM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: false, feedbackTags: ['neutral'],          reviewText: 'Decent explanation of basic CS concepts. Room for improvement in pacing.',                  reviewSubject: 'CS Fundamentals',          feedbackVisibility: 'public', goalAlignmentScore: 58,  reviewCreatedAt: d14 },
      // ── Lakshan Bandara (2 reviews) ───────────────────────────────────────────
      { studentName: 'Kasun Rajapaksha',  volunteer: studyVols[4]._id, volunteerName: 'Lakshan Bandara', subject: 'Networking', date: d30, timeSlot: '10:00 AM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: false, feedbackTags: ['positive'],         reviewText: 'Lakshan explained subnetting clearly. Good practical examples.',                            reviewSubject: 'Subnetting',               feedbackVisibility: 'public', goalAlignmentScore: 68,  reviewCreatedAt: d30 },
      { studentName: 'Roshan Jayasinghe', volunteer: studyVols[4]._id, volunteerName: 'Lakshan Bandara', subject: 'Networking', date: d14, timeSlot: '02:00 PM', message: '-', status: 'completed', rating: 4, followUpMatchAgain: false, feedbackTags: ['neutral'],          reviewText: 'Helpful overview of network protocols. Session was a bit short.',                           reviewSubject: 'Network Protocols',        feedbackVisibility: 'public', goalAlignmentScore: 58,  reviewCreatedAt: d14 },
    ]);
    console.log('✅ 30 seeded review SupportRequests created (consistent with ratingCount on each volunteer)');
