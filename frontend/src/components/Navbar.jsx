      ...
      <div className="navbar-inner container">
        ...
        {user?.role === 'Admin' && (
          <div className="admin-nav-links">
            ...
            <Link to="/rating/admin/moderation" className={`nav-item ${isActive('/rating/admin/moderation') ? 'active' : ''}`}>
              <Star size={16} />
              <span>Reviews</span>
            </Link>
          </div>
        ...
        {/* Student / Volunteer feature links */}
        {user && (user.role === 'Student' || user.role === 'Volunteer') && (
          <div className="admin-nav-links">
            <Link to="/rating/volunteers" className={`nav-item ${isActive('/rating/volunteers') ? 'active' : ''}`}>
              <Star size={16} />
              <span>Ratings</span>
            </Link>
            <Link to="/rating/leaderboard" className={`nav-item ${isActive('/rating/leaderboard') ? 'active' : ''}`}>
              <Users size={16} />
