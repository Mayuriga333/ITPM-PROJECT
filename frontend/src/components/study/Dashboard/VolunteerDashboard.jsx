...
const VolunteerDashboard = () => {
  ...
  const volunteerId = user?._id || storage.getCurrentVolunteer()?._id;
      ...
      <div className="flex gap-8 min-h-screen">
        ...
        <aside className="w-72 h-screen bg-transparent border-none pl-16 pt-12 flex flex-col">
          ...
          <div className="mt-auto pt-6 border-t border-white/10">
            <p className="text-[10px] font-semibold tracking-[0.15em] text-indigo-300/50 mb-3">NAVIGATE</p>
            <nav className="space-y-2">
              <button
                type="button"
                onClick={() => window.location.href = '/volunteer'}
                className="w-full flex items-center gap-3 px-6 py-3 rounded-2xl text-sm font-medium text-indigo-200 hover:bg-white/5 transition-colors"
              >
