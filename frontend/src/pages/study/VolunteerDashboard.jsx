...
import Avatar from '../../components/study/common/Avatar';
import { useAuth } from '../../context/AuthContext';
import { volunteerAPI, requestAPI } from '../../services/api';
import toast from 'react-hot-toast';
import StarRating from '../../components/study/common/StarRating';
...
export default function VolunteerDashboard() {
  ...
  // Prefer the StudyVolunteer._id stored at login; fall back to user._id
  const storedVol = JSON.parse(localStorage.getItem('currentVolunteer') || 'null');
  const volunteerId = storedVol?._id || user?._id;
